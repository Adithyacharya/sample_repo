...
def test_message_activity_sms_messages_dropped_type(
    ...
    try:
        ...
        logger.info(
            "********* TC49 : Message Activity filter using Type as SMS Messages Dropped ********"
        )
        ...
        message_activity_page.select_message_type("SMS Messages Dropped")
        ...
        report_file_name = config["TC49"]["report_file_name"]
        ...
        headers = config["TC49"]["header_list"]
        test_case_data = [str(header.strip()) for header in headers.split(",")]
        ...
        test_case_data = config["TC49"]["report_type"]
