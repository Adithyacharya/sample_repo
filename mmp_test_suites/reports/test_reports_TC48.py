...
def test_message_activity_sms_messages_received_type(
    ...
    try:
        ...
        logger.info(
            "********* TC48 : Message Activity filter using Type as SMS Messages Received ********"
        )
        ...
        message_activity_page.select_message_type("SMS Messages Received")
        ...
        report_file_name = config["TC48"]["report_file_name"]
        ...
        headers = config["TC48"]["header_list"]
        test_case_data = [str(header.strip()) for header in headers.split(",")]
        ...
        test_case_data = config["TC48"]["report_type"]
