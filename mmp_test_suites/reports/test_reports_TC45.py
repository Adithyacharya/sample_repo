...
def test_message_activity_all_messages_type(chrome_driver, logger, screen_shots_list):
    try:
        ...
        message_activity_page.select_message_type("All Messages")
        ...
        report_file_name = config["TC45"]["report_file_name"]
        ...
        headers = config["TC45"]["header_list"]
        test_case_data = [str(header.strip()) for header in headers.split(",")]
        ...
        test_case_data = config["TC45"]["report_type"]
