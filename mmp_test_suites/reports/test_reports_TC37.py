...
def test_voice_activity_dropped_call_call_type_tdm_call_mode(
    ...
    try:
        ...
        logger.info(
            "********* TC37 : Voice Activity filter using Call Type : Dropped call & Call Mode : TDM ********"
        )
        ...
        voice_activity_page.select_call_type_drop_down("dc")
        ...
        voice_activity_page.select_call_mode_drop_down("tdm")
        ...
        headers = config["report_activities_voice"]["header_list_dropped_call"]
        ...
        report_file_name = config["TC37"]["report_file_name"]
        ...
        headers = config["TC37"]["header_list"]
        test_case_data = [str(header.strip()) for header in headers.split(",")]
        ...
        test_case_data = config["TC37"]["report_type"]
        ...
        for voice_data in data_dict_list:
            assert voice_data["Call mode"].lower() == "tdm"
