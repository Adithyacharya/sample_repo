...
def test_voice_activity_all_call_type_tdm_call_mode(
    ...
    try:
        ...
        logger.info(
            "********* TC25 : Voice Activity filter using Call Type : All & Call Mode : TDM ********"
        )
        ...
        report_file_name = config["TC25"]["report_file_name"]
        ...
        headers = config["TC25"]["header_list"]
        test_case_data = [str(header.strip()) for header in headers.split(",")]
        ...
        test_case_data = config["TC25"]["report_type"]
