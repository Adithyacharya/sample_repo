...
def test_message_activity_all_whatsapp_messages_type(
    ...
    try:
        ...
        logger.info(
            "********* TC50 : Message Activity filter using Type as All Whatsapp Messages ********"
        )
        ...
        message_activity_page.update_wait_time(25)
        message_activity_page.select_message_type("All WhatsApp Messages")
        ...
        report_file_name = config["TC50"]["report_file_name"]
        ...
        headers = config["TC50"]["header_list"]
        test_case_data = [str(header.strip()) for header in headers.split(",")]
        ...
        test_case_data = config["TC50"]["report_type"]
