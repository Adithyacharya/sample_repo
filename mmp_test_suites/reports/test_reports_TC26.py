...
def test_voice_activity_all_call_type_data_call_mode(
    ...
    try:
        ...
        logger.info(
            "********* TC26 : Voice Activity filter using Call Type : All & Call Mode : Data********"
        )
        ...
        report_file_name = config["TC26"]["report_file_name"]
        ...
        headers = config["TC26"]["header_list"]
        test_case_data = [str(header.strip()) for header in headers.split(",")]
        ...
        test_case_data = config["TC26"]["report_type"]
